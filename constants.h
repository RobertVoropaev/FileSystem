...
const int DIRECTORY_ELEMENT_SIZE = 16;
const int FILE_NAME_SIZE = DIRECTORY_ELEMENT_SIZE - 4 - 2;
const int MAX_FILE_IN_DIRECTORY = BLOCK_SIZE / DIRECTORY_ELEMENT_SIZE;
